...
export async function runAskCommand(roomId: string, event: MessageEvent<MessageEventContent>, args: string[], client: MatrixClient) {
    const xwiki_ai_api = process.env.XWIKI_URL || "http://192.168.150.82:15480/xwiki/rest/gptsearch/chat/completion";
    ...
    axios.post(xwiki_ai_api, {
        ...
        .then(function (response) {
            ...
            let formattedAiReply = `<i>Assistant's response:</i> <b>${aiReply}</b>`;
        ...
        .catch(function (error) {
            ...
            const defaultMessage = "The assistant is currently unavailable. Please try again later.";
